...
EQUITY = [("Owner's Capital", 0), ("Owner's Withdrawal", 0), ("Owner's Contribution", 0), ("Interest Revenue", 0), ("Sales Revenue", 0),
          ("Rent Revenue", 0), ("Dividend Revenue", 0), ("Operating Revenue", 0),("Insurance Expense", 0), ("Salaries Expense", 0),
          ("Utilities Expense", 0), ("Rent Expense", 0), ("Bank Expense", 0)]
